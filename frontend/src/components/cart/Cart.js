...
const checkoutHandler = ({ history, location }) => {
                    ...
                    <div className="row d-flex justify-content-between">
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-4 col-lg-3 mt-4 mt-lg-0">
                                                <div className="stockCounter d-inline">
                                                    ...
                                                    count d-inline" value={item.quantity} readOnly />
                                            ...
                                            <div className="col-4 col-lg-1 mt-4 mt-lg-0">
                                                <i id="delete_cart_item" className="fa fa-trash btn 
                                                 btn-danger" onClick={() => removeCartItemHandler(item.product)}></i>
                                            </div>
                        ...
                        <div className="col-12 col-lg-3 my-4">
                            <div id="order_summary">
                                ...
                                btn-block" onClick={checkoutHandler}>Check out</button>
                            </div>
                        </div>
                    </div>
                </Fragment>
